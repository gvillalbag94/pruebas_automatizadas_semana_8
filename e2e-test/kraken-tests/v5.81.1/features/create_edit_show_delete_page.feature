Feature: Como usuario puedo crear una nueva pagina, ver la pagina en la lista de paginas, editarla
    y ver que existe con su nuevo nombre.

  @user1 @web
  Scenario: Como usuario inicio sesion con credenciales correctas, creo una pagina, luego la veo en la lista de paginas, luego la edito, confirmo que existe con su nuevo nombre.
    ...
    And I edit the title with the name "Edit page"
