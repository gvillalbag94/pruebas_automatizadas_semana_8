...
cy.screenshot('../create_edit_add_tag_delete/before_12');
  ...
  cy.wait(500);
   ...
   cy.get('button[title="Settings"]').click();
   cy.screenshot('../create_edit_add_tag_delete/before_28');
   cy.wait(500);

   cy.get('button[data-test-button="delete-post"]').click();
cy.screenshot('../create_edit_add_tag_delete/before_29');
    cy.wait(500);

   cy.get('button[data-test-button="delete-post-confirm"]').click();
   cy.screenshot('../create_edit_add_tag_delete/before_30');
   cy.wait(500);

   cy.get("div[class='posts-list gh-list  feature-memberAttribution']")
   .should('not.contain',"Edit TAG cypress page");
   cy.screenshot('../create_edit_add_tag_delete/before_31');
    cy.wait(500);
})
})
