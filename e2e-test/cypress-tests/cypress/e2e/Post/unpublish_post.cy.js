...
/*  */
  it('Scenario Unpublish Posts', () => {
    ...
    cy.wait(3000); 
    //I click on the Edit Published register button
    cy.get('body > div.gh-app > div > main > section > section > div.posts-list.gh-list.feature-memberAttribution > div:nth-child(1)').click();
    cy.wait(3000); 
    //I click on Unpublish
    cy.get('body > div.gh-app > div > main > div.flex.flex-row> section > header > section > button.gh-btn.gh-btn-editor.darkgrey.gh-unpublish-trigger > span').click();
    cy.wait(3000); 
    //I click on Unpublish and revert to private draft
