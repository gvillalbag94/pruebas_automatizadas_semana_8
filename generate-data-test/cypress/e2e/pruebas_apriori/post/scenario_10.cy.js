...
context('Random Data Apriori: Scenario 10 By Victor', () => {

    let title = pagesData[9].title;
    let Subtitle = pagesData[9].subtitle;
    let Subtitle_ = pagesData[9].subtitle_;
    ...
    it('Create, Edit and Delete a new Draft with Real Data',() => {
        //Process Login
        login.signinEvent();
