...
context('Random Data Apriori: Scenario 8 By Victor', () => {

    let title = pagesData[7].title;
    let Subtitle = pagesData[7].subtitle;
    let Subtitle_ = pagesData[7].subtitle_;
    ...
    it('Create, Edit and Delete a new Draft with emails',() => {
        //Process Login
        login.signinEvent();
