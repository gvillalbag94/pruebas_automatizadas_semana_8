...
context('Random Data Apriori: Scenario 9 By Victor', () => {

    let title = pagesData[8].title;
    let Subtitle = pagesData[8].subtitle;
    let Subtitle_ = pagesData[8].subtitle_;
    ...
    it('Create, Edit and Delete a new Draft with Urls',() => {
        //Process Login
        login.signinEvent();
