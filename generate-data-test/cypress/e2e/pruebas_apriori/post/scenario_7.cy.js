...
context('Random Data Apriori: Scenario 7 By Victor', () => {

    let title = pagesData[6].title;
    let Subtitle = pagesData[6].subtitle;
    let Subtitle_ = pagesData[6].subtitle_;
    ...
    it('Create, Edit and Delete a new Draft with a Numbers',() => {
        //Process Login
        login.signinEvent();
