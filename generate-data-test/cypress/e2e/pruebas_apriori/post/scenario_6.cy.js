...
context('Random Data Apriori: Scenario 6 By Victor', () => {

    let title = pagesData[5].title;
    let Subtitle = pagesData[5].subtitle;
    let Subtitle_ = pagesData[5].subtitle_;
    ...
    it('Create, Edit and Delete a new Draft with alphanumeric',() => {
        //Process Login
        login.signinEvent();
