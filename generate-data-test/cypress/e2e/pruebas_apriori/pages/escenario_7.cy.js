...
context('Datos Apriori: Crear una Page con una palabra hexadecimal de 10 caracteres', () => {

    let title = pagesData[6].title;
    let description = pagesData[6].description;
    let urlSlug = pagesData[6].slug;
