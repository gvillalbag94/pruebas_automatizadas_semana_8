...
context('Datos Apriori: Crear una Page con 10 palabras alfabeticas', () => {

    let title = pagesData[2].title;
    let description = pagesData[2].description;
    let urlSlug = pagesData[2].slug;

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con 10 palabras alfabeticas',() => {
        login.signinEvent();
