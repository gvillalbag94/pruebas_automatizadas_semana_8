...
context('Datos Apriori: Crear una Page con una palabra alfabético', () => {

    let title = pagesData[1].title;
    let description = pagesData[1].description;
    let urlSlug = pagesData[1].slug;

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con una palabra alfabético',() => {
        login.signinEvent();
