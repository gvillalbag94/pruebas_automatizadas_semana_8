...
context('Datos Aleatorios: Crear una Page con una palabra hexadecimal de 10 caracteres', () => {

    let title = faker.string.hexadecimal({ length: 10 });
    let description = faker.string.hexadecimal({ length: 10 });
    let urlSlug = faker.string.hexadecimal({ length: 10 });

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con una palabra hexadecimal de 10 caracteres',() => {
        login.signinEvent();
