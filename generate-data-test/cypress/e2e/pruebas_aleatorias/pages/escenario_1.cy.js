...
context('Datos Aleatorios: Crear una Page con un caracter alfabético', () => {
    
    let title = faker.string.alpha();
    let description = faker.string.alpha();
    let urlSlug = faker.string.alpha();

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con un caracter alfabético',() => {
        login.signinEvent();
