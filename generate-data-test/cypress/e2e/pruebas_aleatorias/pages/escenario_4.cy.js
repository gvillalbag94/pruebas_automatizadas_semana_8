...
context('Datos Aleatorios: Crear una Page con un caracter numerico',  () => {

    let title = faker.string.numeric();
    let description = faker.string.numeric();
    let urlSlug = faker.string.numeric();

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con un caracter numerico',() => {
        login.signinEvent();
