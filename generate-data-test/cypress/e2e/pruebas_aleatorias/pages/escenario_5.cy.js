...
context('Datos Aleatorios: Crear una Page con un caracter especial', () => {

    let title = faker.string.symbol();
    let description = faker.string.symbol();
    let urlSlug = faker.string.symbol();

    beforeEach(() => {
       initGhost.visitGhost();
    });

    it('Creación de una palabra con titulo, descripción y slug con un caracter especial',() => {
        login.signinEvent();
