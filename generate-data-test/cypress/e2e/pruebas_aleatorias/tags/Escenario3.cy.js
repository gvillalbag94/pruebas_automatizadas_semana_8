...
context('Generar una descripcion mayor al limite de caracteres permitidos', () => {
    ...
    it('Escenario 3',() => {
        ...
        cy.wait(2000);
        cy.get('textarea[id="tag-description"]').click({force:true}).type(faker.string.alpha(600))
        cy.wait(2000);
