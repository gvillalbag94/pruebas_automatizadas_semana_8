...
context('Random Data: Scenario 2 By Victor', () => {

    let title = faker.internet.displayName();
    let Subtitle = faker.hacker.phrase();
    ...
    it('Create, Publish and Delete a new Draft with a hacker phrase',() => {
        //Process Login
        login.signinEvent();
