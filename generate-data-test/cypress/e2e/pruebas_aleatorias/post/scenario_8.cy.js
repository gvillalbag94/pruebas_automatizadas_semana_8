...
context('Random Data: Scenario 8 By Victor', () => {

    let title = faker.music.genre();
    let Subtitle = faker.string.alpha();
    let Subtitle_ = faker.hacker.phrase();
    ...
    it('Create, Edit and Delete a new Draft with an multiple caracters',() => {
        //Process Login
        login.signinEvent();
