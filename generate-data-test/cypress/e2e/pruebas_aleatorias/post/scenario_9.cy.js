...
context('Random Data: Scenario 9 By Victor', () => {

    let title = faker.number.binary(255);
    let Subtitle = faker.string.alpha();
    let Subtitle_ = faker.number.binary(255);
    ...
    it('Create, Edit and Delete a new Draft with Numbers',() => {
        //Process Login
        login.signinEvent();
