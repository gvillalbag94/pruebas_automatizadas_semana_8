...
console.log(inputValues);
  ...
  (async () => {
    ...
    for(b of browsers){
      ...
      // Ejecución de la prueba exploratoria para el inicio de sesión.
      await recursiveExploration(page, baseUrl, 0, -1); 

      // Ejecución de la prueba exploratoria para los flujos y vistas restantes en la plataforma.
      await recursiveExploration(page, baseUrl, 0, -1); 
